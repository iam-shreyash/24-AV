...
export default function Home() {
  ...
  const vendorPartnerFeatures = [
    ...
    },
    {
      ...
      description: "Show customers your verified business credentials for higher trust and more bookings."
    },
    {
      icon: TrendingUp,
      title: "Earnings & Payouts",
      description: "Track your income, payouts, and financial performance from one dashboard."
    }
  ];
          ...
          <ScrollAnimate type="fade-in" threshold={0.2}>
            <div className="mb-12 text-center">
              <h2 className="font-heading text-4xl font-bold text-blue-800 md:text-5xl">
                {auth?.role === "vendor" ? "Why Partner with 24AV?" : "Why Choose 24AV?"}
              </h2>
              <p className="mt-4 font-body text-lg text-gray-600">
                {auth?.role === "vendor" 
                  ? "Grow your aviation business with India's most trusted platform."
                  : "Experience the difference with India's most trusted aviation platform"
                }
              </p>
            </div>
          </ScrollAnimate>
